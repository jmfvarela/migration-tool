...
const input = fs.readFileSync("data/input/FizzBuzz.js", "utf8");
const ast = parser.parse(input);

const json = JSON.stringify(ast, null, 4);
fs.writeFileSync("data/output/FizzBuzz.json", json);

const output = migrate(ast);
fs.writeFileSync("data/output/FizzBuzz.js", output);
console.log(output);
